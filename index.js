...
document.addEventListener("keypress", function (event) {
    ...
    playSound(event.key); // sends (event.key) value to playSound() function.
    animation(event.key);
})
...
/* 
1. This keyword - Gives us the identity of the element,
 that means the whole HMTL code from which it is made.
*/